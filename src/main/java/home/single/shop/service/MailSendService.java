...
import home.single.shop.util.MailConfig;
...
public class MailSendService {
	// 이메일 전송
		public String makeEmail(String email){
			...
			// 전송할 이메일 양식
			String setFrom = "kangjihoon31502@gmail.com"; // gmail smtp 스팸정책? 때문에 보내는사람 변경이 어렵다함
