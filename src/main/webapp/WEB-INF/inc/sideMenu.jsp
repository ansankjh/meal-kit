...
<aside class="sidebar-wrapper" data-simplebar="true">
	<div class="sidebar-header">
		<div>
			<img src="/shop/assets/images/K.png" class="logo-icon" alt="logo icon">
		</div>
		<a href="${pageContext.request.contextPath}/employee/employeeMain">
	...
	<ul class="metismenu" id="menu">
		...
		<li>
			...
			<ul>
				<li><a href="${pageContext.request.contextPath}/employee/sales/payStatistics"><i class="bi bi-circle"></i>통계</a></li>
				<li><a href="${pageContext.request.contextPath}/employee/sales/payStatisticsChart"><i class="bi bi-circle"></i>통계</a></li>
			</ul>
		</li>
	</ul>
	<!--end navigation-->
